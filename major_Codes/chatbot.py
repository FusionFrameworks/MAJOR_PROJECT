...
#     # Create a response to the incoming WhatsApp message
#     response_message = "Thank you for contacting us. A healthcare professional will reach out to you shortly."
...
# Create a dictionary for symptoms to diseases mapping in English
symptoms_to_disease = {
    "high temperature": "Fever",
    "chills": "Fever",
    "sweating": "Fever",
...
def chat():
    ...
    if diseases:
        ...
        # Send WhatsApp message after predicting the disease
        send_whatsapp_message('+918804339456', response)
